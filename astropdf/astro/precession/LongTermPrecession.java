...
import static astropdf.astro.time.AstroUtil.radsToDegreeString;
import static astropdf.astro.time.AstroUtil.radsToTimeString;

import astropdf.astro.coords.Position;
import astropdf.astro.star.Star;
import astropdf.astro.time.AstroUtil;
import astropdf.astro.time.GregorianCal;
import astropdf.math.Maths;
import astropdf.math.Matrix;
import astropdf.math.Vector;
...
public final class LongTermPrecession {
  ...
  */
  ...
  public static void main(String... args) {
    ...
    jd = GregorianCal.jdForGreenwich(2028,  11, 13.19); //2462088.69
    Star star = new Star();
  ...
  private static void testObliquity(int year) {
    LongTermPrecession p = new LongTermPrecession();
    double jd = GregorianCal.jdForGreenwich(year, 1, 0.0);
